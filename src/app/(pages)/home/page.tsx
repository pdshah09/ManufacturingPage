...
export default function HomePage() {
  return (
    <>
      <a className="o_skip_to_content" href="#wrap">Skip to Content</a>

      {/* ─────────────── NAVBAR ─────────────── */}
      <header id="top" className="o_main_header">
        <div className="o_header_inner">
          <a href="/" className="o_logo" aria-label="Odoo"><span className="sr-only">Odoo</span></a>
                ...
                <div className="o_secondary_nav">
                  <div className="o_secondary_nav_inner">
                    ...
                    <div className="o_nav_footer">
                      <a href="https://apps.odoo.com/apps/modules" target="_blank" rel="noopener noreferrer">Third party apps</a>
                      <a href="/app/studio">Odoo Studio</a>
                      <a href="https://www.odoo.sh" target="_blank" rel="noopener noreferrer">Odoo Cloud Platform</a>
                    </div>
                  </div>
                </div>
              </li>
          ...
          <ul className="o_header_buttons">
            <li><a href="/web/login" className="o_nav_link">Sign in</a></li>
            <li><a href="/trial?selected_app=mrp" className="btn btn-primary btn-sm trial_link">Try it free</a></li>
          </ul>
        </div>
      </header>
      ...
      <main id="wrap">
            ...
            <div className="hero_lead_row">
              <div>
                ...
                <div className="hero_cta_group">
                  <a className="btn btn-primary" href="/trial?selected_app=mrp">Start now - It&apos;s free</a>
                  <div className="o_schedule_demo">
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu" role="menu">
                        <li><a className="dropdown-item" href="/appointment/7440" target="_blank" rel="noopener noreferrer">Micro Business (1–5 employees)</a></li>
                        <li><a className="dropdown-item" href="/appointment/181" target="_blank" rel="noopener noreferrer">Small Business (6–50 employees)</a></li>
                        <li><a className="dropdown-item" href="/appointment/6865" target="_blank" rel="noopener noreferrer">Midsized company (51–250 employees)</a></li>
                        <li><a className="dropdown-item" href="/appointment/1113" target="_blank" rel="noopener noreferrer">Large company (250+ employees)</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div className="container">
            <div className="hero_img_wrap">
              <div className="x_wd_corner_highlight s_panel_video">
                <a href="#" className="btn_video_play" aria-label="Watch Odoo Manufacturing demo">
        ...
        <div className="s_wd_persona">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img className="s_wd_persona_bg" alt="" aria-hidden="true"
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img alt="" aria-hidden="true" className="s_wd_persona_icon"
          ...
          <div className="container">
            <div className="row row-feature row-reverse">
              <div className="col-text">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://odoocdn.com/openerp_website/static/src/img/arrows/grey_arrow_dot_02.svg"
              ...
              <div className="col-media">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/operations.webp"
        ...
        <section className="o_section text-center-lg">
          <div className="container">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="https://odoocdn.com/openerp_website/static/src/img/icons/calendar.svg"
            ...
            <div className="img-wide-wrap">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/schedule.webp"
          ...
          <div className="container">
            <div className="row row-feature">
              ...
              <div className="col-media text-center">
                ...
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://odoocdn.com/openerp_website/static/src/img/graphics/arrow_doodle_13.svg"
                  className="rotate-320" width={60} height={60} alt="" aria-hidden="true" loading="lazy"/>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/barcode.webp"
          ...
          <div className="container">
            <div className="row row-feature row-reverse">
              <div className="col-media col-media--overlap">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/become_paperless_03.webp"
                  className="img-thumbnail paperless-float paperless-float--tl" alt="" loading="lazy" width={200} height={160}/>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/become_paperless_01.webp"
                  className="img-thumbnail paperless-float paperless-float--br" alt="" loading="lazy" width={200} height={160}/>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/become_paperless_02.webp"
        ...
        <section className="o_section">
          <div className="container">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="https://odoocdn.com/openerp_website/static/src/img/icons/tick.svg"
            ...
            <div className="row row-feature">
              ...
              <div className="col-media col-media--wide">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/sigma_6.webp"
        ...
        <section className="o_section">
          <div className="container">
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/kaizen.svg"
        ...
        <section className="s_wd_features">
          <div className="container">
              ...
              <div className="features-col">
                <div className="s_wd_features_item s_wd_features_item--overflow">
                  <div className="s_wd_features_icon">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src="https://odoocdn.com/openerp_website/static/src/img/icons/yellow_star.svg" alt="" loading="lazy" width={32} height={32}/>
                  </div>
                  ...
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="https://odoocdn.com/openerp_website/static/src/img/apps/manufacturing/features_01.webp"
            ...
            <a href="/app/manufacturing-features" className="features-all-link">
              See all features
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://odoocdn.com/openerp_website/static/src/img/arrows/secondary_arrow_sm_03.svg"
        ...
        <section className="s_wd_related_apps">
          <div className="container">
            ...
            <div className="related-apps-grid">
              {RELATED_APPS.map((app) => (
                <div key={app.label} className="x_wd_app_horizontal">
                  <a href={app.href} className="app-icon-link">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
            ...
            <a href="/page/all-apps" className="features-all-link">
              See all Apps
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://odoocdn.com/openerp_website/static/src/img/arrows/secondary_arrow_sm_03.svg"
                width={40} height={20} alt="" aria-hidden="true" loading="lazy"/>
        ...
        <section className="s_wd_testimonial">
          <div className="container">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="https://odoocdn.com/openerp_website/static/src/img/arrows/grey_arrow_loop_02.svg"
              width={150} height={100} className="testimonial-arrow" alt="" aria-hidden="true" loading="lazy"/>
            <div className="testimonial-card">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://odoocdn.com/openerp_website/static/src/img/snippets/s_wd_testimonials/quote.svg"
              ...
              <div className="testimonial-author">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img height={90} width={90} className="testimonial-avatar"
                ...
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img width={100} height={50} className="img-thumbnail testimonial-logo"
        ...
        <section className="s_wd_call_to_action">
          <div className="container">
            ...
            <a className="btn btn-primary btn-lg" href="/trial?selected_app=mrp">Start now - It&apos;s free</a>
            {/* eslint-disable-next-line @next/next/no-img-element */}
        ...
        <div id="footer" className="container">
          ...
          <div className="o_footer_grid">
              ...
              <div className="o_footer_sub">
                ...
                <div>
                  ...
                  <ul className="o_footer_links">
                    ...
                    <li><a href="https://github.com/odoo/odoo" target="_blank" rel="noopener noreferrer">Github</a></li>
                    <li><a href="https://runbot.odoo.com/" target="_blank" rel="noopener noreferrer">Runbot</a></li>
                    <li><a href="https://github.com/odoo/odoo/wiki/Translations" target="_blank" rel="noopener noreferrer">Translations</a></li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="o_footer_col">
              ...
              <ul className="o_footer_links">
                <li><a href="https://www.odoo.sh" target="_blank" rel="noopener noreferrer">Odoo.sh Hosting</a></li>
                <li><a href="/help">Support</a></li>
                <li><a href="https://upgrade.odoo.com" target="_blank" rel="noopener noreferrer">Upgrade</a></li>
            ...
            <div className="o_footer_col">
              ...
              <ul className="o_footer_links">
                ...
                <li><a href="//podcast.odoo.com" target="_blank" rel="noopener noreferrer">Podcast</a></li>
                <li><a href="/blog">Blog</a></li>
                <li><a href="/blog/6">Customers</a></li>
                <li><a href="/legal">Legal</a> &bull; <a href="/privacy">Privacy</a></li>
                <li><a href="/security">Security</a></li>
              </ul>
            </div>
            <div className="o_footer_col o_footer_right">
              <div className="o_footer_social">
                <a href="https://twitter.com/Odoo" target="_blank" rel="noopener noreferrer" aria-label="Odoo on Twitter">
                ...
                <a href="https://www.linkedin.com/company/odoo" target="_blank" rel="noopener noreferrer" aria-label="Odoo on LinkedIn">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                <a href="https://www.facebook.com/odoo" target="_blank" rel="noopener noreferrer" aria-label="Odoo on Facebook">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.github.com/odoo" target="_blank" rel="noopener noreferrer" aria-label="Odoo on GitHub">
